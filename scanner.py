...
def prepare_args():
	...
	"""
	parser = ArgumentParser(description="Python Based Port Scanner", usage="%(prog)s 192.168.0.102", epilog="Example - %(prog)s -s 20 -e 40000 -t 500 -V 192.168.0.102")
...
def prepare_threads(threads:int):
	"""create,start,join threads
		   ...
		   arguments:
			  threads(int) - Number of threads in use
	"""
